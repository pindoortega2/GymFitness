...
/*
    ...
    Description: Añade información al sitio web con un diseño agradable 
    Version: 1.0.0
...
if(!defined('ABSPATH')) die(); //Esto bloquea el accesos a los archivos del plugin es una funcion de wordpress
...
function gymfitness_clases_post_type() {
	...
	$args = array(
		...
		'show_in_menu'          => true,
        'menu_position'         => 6,
        'menu_icon'             => 'dashicons-shortcode', //iconos wordpress https://developer.wordpress.org/resource/dashicons/#shortcode
...
//Custom Post Type para los instructores
function gymfitness_instructores_post_type() {
	...
	$labels = array(
		...
		'all_items'             => __( 'Todas Los Instructores', 'gymfitness' ),
